//! Internationalization (i18n) module for Moxin Translator
//!
...
pub fn init_translations() {
    ...
    en.insert("app.title".to_string(), "Moxin Translator".to_string());
    en.insert(
        "nav.text_to_speech".to_string(),
    ...
    en.insert(
        "voice.filter.character".to_string(),
        "Character".to_string(),
    );
    ...
    en.insert(
        "tts.input_placeholder".to_string(),
        "Enter text to convert to speech...".to_string(),
    );
    ...
    en.insert(
        "clone.express_desc".to_string(),
        "Clone voice with 5-10 seconds of audio".to_string(),
    );
    en.insert("clone.pro_mode".to_string(), "Pro Mode".to_string());
    en.insert(
        "clone.pro_desc".to_string(),
        "High-quality voice with 3-10 minutes training".to_string(),
    );
    ...
    en.insert(
        "clone.start_recording".to_string(),
        "Start Recording".to_string(),
    );
    en.insert(
        "clone.stop_recording".to_string(),
    ...
    en.insert(
        "clone.training_progress".to_string(),
        "Training Progress".to_string(),
    );
    en.insert("settings.title".to_string(), "Settings".to_string());
    en.insert(
        "settings.voice_settings".to_string(),
        "Voice Settings".to_string(),
    );
    en.insert(
        "settings.default_speed".to_string(),
        "Default Speed".to_string(),
    );
    en.insert(
        "settings.default_pitch".to_string(),
        "Default Pitch".to_string(),
    );
    en.insert(
        "settings.default_volume".to_string(),
        "Default Volume".to_string(),
    );
    en.insert(
        "settings.output_format".to_string(),
    ...
    en.insert(
        "settings.check_update".to_string(),
    ...
    en.insert(
        "status.dora_running".to_string(),
        "Dora Running".to_string(),
    );
    en.insert(
        "status.dora_stopped".to_string(),
        "Dora Stopped".to_string(),
    );
    en.insert(
        "error.dora_not_running".to_string(),
        "Please start Dora first".to_string(),
    );
    en.insert(
        "error.no_voice_selected".to_string(),
        "Please select a voice".to_string(),
    );
    en.insert(
        "error.no_text_input".to_string(),
        "Please enter text".to_string(),
    );

    // Chinese translations
    let mut zh = HashMap::new();
    zh.insert("app.title".to_string(), "魔音翻译".to_string());
